...
const TrendingDestination = () => {
  return (
    <section className="w-full flex flex-col items-center justify-center py-12 sm:py-16 md:py-20 mb-8 sm:mb-12 md:mb-16 bg-gradient-to-br from-gray-50 to-white">
      {/* Header */}
      <br />
      <br />
      <div className="text-center mb-8 sm:mb-12 md:mb-16 lg:mb-20 px-4">
        <div className="flex items-center justify-center mb-6 sm:mb-8">
          <div className="h-px bg-gradient-to-r from-transparent via-amber-400 to-transparent w-32 sm:w-40 md:w-48"></div>
        </div>
        <br />
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl lg:shadow-2xl bg-white">
          {/* Image Container */}
          <div className="relative w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/10 via-black/20 to-black/50 flex items-center justify-center">
              <h3 className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-serif font-bold tracking-wider drop-shadow-2xl text-center px-4">
                SIGIRIYA
              </h3>
            </div>
          </div>
          ...
          {/* Description */}
          <div className="p-6 sm:p-8 md:p-10 lg:p-12 bg-white flex items-center justify-center">
            <div className="max-w-4xl mx-auto text-center">
              <br />
              <p className="text-gray-800 font-lato text-base sm:text-lg md:text-xl leading-6 sm:leading-7 md:leading-8 font-light tracking-wide px-2 sm:px-0">
              ...
              <br />
              <p className="text-gray-700 font-lato text-sm sm:text-base md:text-lg leading-5 sm:leading-6 md:leading-7 font-light px-2 sm:px-0">
